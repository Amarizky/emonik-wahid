                    ...
                    <table class="table datatable-button-html5-columns">
                        <thead>
                            <tr>
                                ...
                                <th>Bahan 6</th>
                                <th>Bahan 7</th>
                                <th>Berat Bahan 1(ton)</th>
                                <th>Berat Bahan 2(ton)</th>
                                <th>Berat Bahan 3(ton)</th>
                                <th>Berat Bahan 4(ton)</th>
                                <th>Berat Bahan 5(ton)</th>
                                <th>Berat Bahan 6(ton)</th>
                                <th>Berat Bahan 7(ton)</th>
                                <th>Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            foreach ($datatable as $row) {
                                $bt = '<a href="' . site_url(current_group() . '/' . $menu_alias . "/edit/" . $row->mitra) . '" class="dropdown-item"><i class="icon-pencil5"></i> Edit</a>';
                                ...
                                echo "
                                            <tr>
                                                ...
                                                <td>" . ($row->bahan6 ?? '-') . "</td>
                                                <td>" . ($row->bahan7 ?? '-') . "</td>
                                                <td>" . ($row->stokbahan1 ?? '-') . "</td>
                                                <td>" . ($row->stokbahan2 ?? '-') . "</td>
                                                <td>" . ($row->stokbahan3 ?? '-') . "</td>
                                                <td>" . ($row->stokbahan4 ?? '-') . "</td>
                                                <td>" . ($row->stokbahan5 ?? '-') . "</td>
                                                <td>" . ($row->stokbahan6 ?? '-') . "</td>
                                                <td>" . ($row->stokbahan7 ?? '-') . "</td>
