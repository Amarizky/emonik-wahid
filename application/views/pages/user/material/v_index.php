                                    ...
                                    foreach ($datatable as $row) {
                                        ...
                                        echo "
                                            <tr>
                                                ...
                                                <td>" . ($row->bahan6?? '-') . "</td>
                                                <td>" . ($row->bahan7?? '-') . "</td>
                                                <td>" . ($row->presentase_bahan_baku1?? '-') . "</td>
                                                <td>" . ($row->presentase_bahan_baku2?? '-') . "</td>
                                                <td>" . ($row->presentase_bahan_baku3?? '-') . "</td>
                                                <td>" . ($row->presentase_bahan_baku4?? '-') . "</td>
                                                <td>" . ($row->presentase_bahan_baku5?? '-') . "</td>
                                                <td>" . ($row->presentase_bahan_baku6?? '-') . "</td>
                                                <td>" . ($row->presentase_bahan_baku7?? '-') . "</td>
