    ...
    <div class="sidebar-content">
        ...
        <div class="card card-sidebar-mobile">
            ...
            <!-- hai sayang </3 -->
                ...
                <li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Bahan Baku</div> <i class="icon-menu" title="Main"></i></li>
                ...
                <li class="nav-item">
                    <a href="<?php echo site_url(current_role().'/rekanan');?>" class="nav-link <?php echo $menu == 'Upload Rekanan' ? 'active' : '';?>">
                        <i class="icon-home4"></i>
                        <span>Upload Rekanan/Mitra</span>
                    </a>
                </li>

                <li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Akun & Pengguna</div> <i class="icon-menu" title="Main"></i></li>
                <li class="nav-item">
                    <a href="<?php echo site_url(current_role().'/users');?>" class="nav-link <?php echo $menu == 'Users Account' ? 'active' : '';?>">
